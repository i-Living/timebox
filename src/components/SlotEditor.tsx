      ...
      <div class="modal-sheet" onClick={e => e.stopPropagation()}>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input class="form-input" type="time" value={start} onInput={e => setStart(e.currentTarget.value)} style="width:0;min-width:0;" />
          </div>
          <div class="form-group">
            <label class="form-label">Конец</label>
            <input class="form-input" type="time" value={end} onInput={e => setEnd(e.currentTarget.value)} style="width:0;min-width:0;" />
          </div>
        </div>
